(function () {
  ...
  function setMasterFields(fields) {
    masterFields = fields;
  }
  ...
  function injectFields(config, data = {}) {
  ...
  */
   ...
   */
  function populateAvailableFeatureList() {
  ...
  function FlatpickrInstance(element, instanceConfig) {
      ...
      function setupLocale() {
          if (typeof self.config.locale !== "object" &&
              typeof flatpickr$1.l10ns[self.config.locale] === "undefined")
              self.config.errorHandler(new Error("flatpickr: invalid locale " + self.config.locale));
          self.l10n = __assign(__assign({}, flatpickr$1.l10ns.default), (typeof self.config.locale === "object"
              ? self.config.locale
              : self.config.locale !== "default"
                  ? flatpickr$1.l10ns[self.config.locale]
                  : undefined));
          ...
          if (userConfig.time_24hr === undefined &&
              flatpickr$1.defaultConfig.time_24hr === undefined) {
  ...
  function setupDatepickers() {
    ...
    document.querySelectorAll('input[type="date"]').forEach(input => {
      ...
      const parsed = flatpickr$1.parseDate(input.value, "d-m-Y");
